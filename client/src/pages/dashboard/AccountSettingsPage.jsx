...
import { getProfile, updateProfile, updatePassword, createBillingPortal } from '../../api/settingsApi'
        ...
        {tab === 'Billing' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {PLANS.map(plan => (
                <div key={plan.name} className={clsx('rounded-xl border-2 p-5', user?.plan === plan.name.toLowerCase() ? 'border-indigo-500 bg-indigo-50' : 'border-gray-200')}>
