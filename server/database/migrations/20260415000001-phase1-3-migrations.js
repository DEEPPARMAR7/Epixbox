      ...
      await queryInterface.bulkInsert('Themes', [
        {
          ...
          category: 'light',
          is_builtin: true,
          css_variables: JSON.stringify({ primary: '#000000', secondary: '#666666', background: '#FFFFFF', accent: '#CCCCCC' }),
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          category: 'dark',
          is_builtin: true,
          css_variables: JSON.stringify({ primary: '#FFFFFF', secondary: '#BBBBBB', background: '#1a1a1a', accent: '#333333' }),
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          category: 'vibrant',
          is_builtin: true,
          css_variables: JSON.stringify({ primary: '#FF6B6B', secondary: '#4ECDC4', background: '#FFFFFF', accent: '#FFE66D' }),
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          is_builtin: true,
          css_variables: JSON.stringify({ primary: '#003D7A', secondary: '#666666', background: '#F5F5F5', accent: '#0066CC' }),
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          category: 'artistic',
          is_builtin: true,
          css_variables: JSON.stringify({ primary: '#8B4789', secondary: '#D4A5A5', background: '#F9F7F4', accent: '#E0B0B0' }),
          createdAt: new Date(),
          updatedAt: new Date(),
        },
      ], { transaction });
